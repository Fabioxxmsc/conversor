SE_SEQCLASSEVALOR = 'create sequence seqclassevalor start 1'
SE_DROPSEQCLASSEVALOR = 'drop sequence if exists seqclassevalor'

SE_SEQDOCUMENTO = 'create sequence seqdocumento start 1'
SE_DROPSEQDOCUMENTO = 'drop sequence if exists seqdocumento'

SE_SEQGABARITO = 'create sequence seqgabarito start 1'
